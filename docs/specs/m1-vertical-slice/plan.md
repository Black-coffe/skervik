...
| S1.4.2 intent pipeline · S1.4.3 commit-reveal · S1.4.4 log persist | ⏸ HELD — depend on ADR-0009 Forks 2 (bare-GameEvent log + re-golden) & 3 (reveal location) **pending owner ratification** (asked 2026-07-03). Materialize + dispatch once ratified (S1.4.2/.3 = T3 → Opus + lead-review; S1.4.4 folds the S1.2.1 `RESOURCES_PRODUCED` nit + re-golden). ADR guidance ready per story |
