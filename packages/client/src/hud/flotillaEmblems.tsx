...
// emblem art (petrel silhouette / orca fin / walrus tusks / narwhal horn) is
// a later art-asset story — these are simple, DISTINCT geometric shapes so
// the rail already satisfies "not hue-only" today without blocking on art.
