...
export const uk: Messages = {
  ...
  'a11y.buildSelector': 'Оберіть, що будувати',
  'build.typeSettlement': 'Поселення',
  'build.typeRoad': 'Дорога',
  'build.typeCity': 'Місто',
  ...
  'venture.title': 'Підприємства',
  'venture.buyButton': 'Купити підприємство',
  'venture.deckRemaining': 'Залишилось: {count}',
  'venture.play': 'Розіграти',
  'venture.close': 'Закрити',
  'venture.empty': 'Немає підприємств на руках',
  'venture.boughtThisTurnHint': 'Куплено цього ходу',
  'venture.kind.knight': 'Конвой',
  'venture.kind.roadBuilding': 'Попутний вітер',
  'venture.kind.yearOfPlenty': 'Щедрий приплив',
  'venture.kind.monopoly': 'Скупка',
  'venture.kind.victoryPoint': 'Передовиця',
  'venture.yopPrompt': 'Щедрий приплив: оберіть 2 товари',
  'venture.yopCounter': {
    one: 'Обрано {count} товар із 2',
    few: 'Обрано {count} товари із 2',
    many: 'Обрано {count} товарів із 2',
    other: 'Обрано {count} товари із 2',
  },
  'venture.yopAddResource': 'Додати до вибору: {resource}',
  'venture.yopRemoveResource': 'Прибрати з вибору: {resource}',
